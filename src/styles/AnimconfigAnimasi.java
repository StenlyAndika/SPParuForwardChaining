...
public class AnimconfigAnimasi extends Transition {
     ...
     */
    public AnimconfigAnimasi(final Node node, final Timeline timeline) {
     ...
     */
    public AnimconfigAnimasi(final Node node, final Timeline timeline, final boolean useCache) {
        this.node = node;
